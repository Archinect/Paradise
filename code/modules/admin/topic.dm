...
//Regular jobs
	...
	//Watchlist
		...
		var/dat = {"<meta charset="UTF-8"><B>What mode do you wish to play?</B><HR><table><tr><td>Minplayers</td><td>Gamemode</td></tr>"}
		...
		var/dat = {"<meta charset="UTF-8"><B>What game mode do you want to force secret to be? Use this if you want to change the game mode, but want the players to believe it's secret. This will only work if the current game mode is secret.</B><HR><table><tr><td>Minplayers</td><td>Gamemode</td></tr>"}
		for(var/mode in config.modes)
